...
public class RouterApiStrategy implements ApiDocStrategy {
	...
	public String getRequest(String request) {
		...
		subRequest.put("phone", "${phone}");
		subRequest.put("longitude", "121.48");
		subRequest.put("latitude", "31.23");
		subRequest.put("mobileNo", "${phone}");
		subRequest.put("transDate", "${transDate}");
		subRequest.put("transTime", "${transTime}");
